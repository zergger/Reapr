...
CMAKE_BIN=""
if type -P cmake >/dev/null 2>&1
then
    CMAKE_BIN=$(type -P cmake)
    echo "... found system cmake OK: $CMAKE_BIN"
else
    echo "System cmake not found; will build bundled cmake"
fi
...
------------------------------------------------------------------------------
"
    CMAKE_BIN="$rootdir/third_party/cmake/bin/cmake"
fi
